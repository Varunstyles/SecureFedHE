...
def handle_update(data: dict):
    ...
    if zkp_ok:
        try:
            ...
            # NOTE: rolling-P and joint A*P_rolling signals were tried
            # here as label_flip detection candidates and confirmed
            # NEGATIVE (no separation from honest nodes, at both 30%
            # and 70% poison fraction) — removed as dead log-only code.
            # See context handoff doc for full results.
